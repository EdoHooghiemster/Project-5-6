...
namespace Cheese.Controllers
{
    public class KaasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Naam,Merk,Melksoort,Vet,Biologisch,Kaassoort,Eetbarekorst,Afkomst,Prijs")] Kaas kaas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Naam,Merk,Melksoort,Vet,Biologisch,Kaassoort,Eetbarekorst,Afkomst,Prijs")] Kaas kaas)
        {
            if (id != kaas.Id)
            {
                return NotFound();
